---
description: "Votez pour Valane depuis le site officiel, gagnez des points en jeu et échangez-les contre des clés et récompenses avec /voteshop."
sidebar_position: 4
---

# 🎫 Voter pour Valane

Chaque vote aide **Valane** à gagner en visibilité et à accueillir de nouveaux joueurs. En échange de votre soutien, vous recevez des **points de vote en jeu** à dépenser dans une boutique dédiée.

:::tip Accès direct
👉 [**Ouvrir le site de vote de Valane**](https://valane.fr/vote)
:::
...
1. Ouvrez la [page de vote de Valane](https://valane.fr/vote).
