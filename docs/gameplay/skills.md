---
description: "Découvrez les compétences, niveaux, mana et salaires de Valane, ainsi que les bonus débloqués pour chaque activité Minecraft."
sidebar_position: 2
---
...
:::important
Comme beaucoup de joueurs, il se peut que vous soyez un peu perdu au début, mais ne vous inquiétez pas, on s'y retrouve vite. Si besoin, le staff pourra vous guider sur le [**Discord**](https://discord.valane.fr).
:::
