...
- Des feux de camp ou une tour de chute
- Des torches pour contrôler l'activation
...
3. Divisez-la avec des canaux d'eau.
4. Placez des trappes au bord des ouvertures.
5. Dirigez tous les monstres vers la chute.
6. Installez des entonnoirs et des coffres en dessous.
7. Sécurisez le toit avec des dalles ou de la lumière.
8. Ajoutez un accès permettant d'éclairer l'intérieur.
...
Vérifiez la difficulté, la lumière et la distance du joueur. Les réglages du serveur peuvent aussi limiter le nombre d'entités par île.

### Les monstres restent dans la chambre

Réduisez les zones sèches et contrôlez la portée des courants d'eau.
