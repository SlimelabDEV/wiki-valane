...
3. Ajoutez un renfoncement afin que l'eau descende avant d'atteindre la lave.
4. Placez la lave à l'autre extrémité, derrière un bloc de protection.
5. Laissez les deux flux se rencontrer dans un seul emplacement.
6. Vérifiez que la cobblestone apparaît sans transformer la source de lave.
7. Ajoutez un mur derrière le bloc à miner pour éviter les pertes.
...
- Un coffre pour vider rapidement l'inventaire
- Un plafond qui maintient le joueur à la bonne position
- Un emplacement pour une balise lorsque l'île est avancée
...
L'eau touche directement la source de lave. Coupez l'eau, récupérez ou remplacez la lave si possible, puis corrigez la rigole.

### De la pierre apparaît au lieu de la cobblestone

L'ordre et la hauteur des liquides changent le bloc généré. Reproduisez un modèle simple où la lave s'écoule latéralement vers l'eau.

### Les objets tombent dans le vide
...
Retrouvez toutes les informations utiles dans le [wiki officiel de Valane](/docs/bienvenue).
