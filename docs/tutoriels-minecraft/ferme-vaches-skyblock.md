...
- Deux vaches
- Du blé
- Des barrières ou des murs
- Des trappes
- Un courant d'eau facultatif
- Un coffre
...
3. Ajoutez une ouverture permettant de leur donner du blé sans entrer.
4. Construisez une zone plus basse où les veaux peuvent être déplacés.
5. Fermez tous les côtés donnant sur le vide.
6. Ajoutez un accès séparé pour récupérer les ressources.
...
Vérifiez la hauteur de l'ouverture et le chemin vers la zone basse. Un courant d'eau doux peut aider à les déplacer.

### Les vaches sortent pendant le nourrissage

Utilisez une ouverture d'un demi-bloc, une trappe ou donnez le blé à travers une barrière.
